...
public class Create_new_incident {
    ...
    public void go_to_home_page(){
        ...
        preRequisite.driver.get("https://sainsburystest.service-now.com/");
    }
...
//        preRequisite.driver.findElement(By.name("email")).sendKeys("a");
//    }
//
//
...
//       preRequisite.driver.findElement(By.id("search_field")).sendKeys("tester");
//         preRequisite.driver.findElement(By.cssSelector(".search-button")).click();
//        Thread.sleep(5000);
//    }
//
...
//        String package_title = preRequisite.driver.findElement(By.cssSelector(".package-title ")).getText();
